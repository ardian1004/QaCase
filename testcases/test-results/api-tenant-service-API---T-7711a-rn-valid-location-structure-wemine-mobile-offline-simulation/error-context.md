...
- Name: api\tenant-service.spec.ts >> API - Tenant Service Master Data Tests >> GET /tenant/master/locations - Should return valid location structure
- Location: tests\api\tenant-service.spec.ts:29:7
...
Call log:
  - → GET https://staging.wemine.dev/tenant/master/locations
