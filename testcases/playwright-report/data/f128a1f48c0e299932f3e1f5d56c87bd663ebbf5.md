...
- Name: api\user-service.spec.ts >> API - User Service Integration Tests >> POST /user/who - Should perform tenant lookup successfully
- Location: tests\api\user-service.spec.ts:6:7

# Error details

```
Error: apiRequestContext.post: getaddrinfo ENOTFOUND staging.wemine.dev
Call log:
  - → POST https://staging.wemine.dev/user/who
    - user-agent: Mozilla/5.0 (Linux; Android 11; Pixel 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/153.0.8010.12 Mobile Safari/537.36
    - accept: */*
